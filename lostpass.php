		...
		color:red;
						...
						<form method="POST" autocomplete="off">
							<div style="width:100%; height:100%; padding-top:0%;" align="center">
								...
								<span align="center"><h1><font color="blue">Quên mật khẩu?</font></h1></span>
								<hr style="margin: 15px 0;">
									...
									<table width="80%" align="center" style="padding-top:3%;">
										<tr align="right" height="60px">
											...
											<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="padding: 10px 10px;" class="inpt" name="accx" placeholder="Tài khoản | A-Za-z0-9 | hkdvacc" id="hw_an" pattern="[A-Za-z0-9]+" type="text" size="35">
											<div class = "error"><?php echo isset($error->Accx) ? $error->Accx : '' ?></div>
											</td>
										</tr>
										<tr height="60px">
											<td align="right">Mật khẩu mới:</td>
											<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="padding: 10px 10px;" class="inpt" name="passx" placeholder="Mật khẩu mới | A-Za-z0-9 | ******" id="hw_sk" pattern="[A-Za-z0-9]+" type="password" size="35">
											<div class = "error"><?php echo isset($error->Passx) ? $error->Passx : '' ?></div>
											</td>
										<tr height="60px">
											<td align="right">Mật khẩu 2:</td>
											<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="padding: 10px 10px;" class="inpt" name="passx2" placeholder="Mật khẩu 2 | A-Za-z0-9 | ******" id="hw_sk" pattern="[A-Za-z0-9]+" type="password" size="35">
											<div class = "error"><?php echo isset($error->Passx2) ? $error->Passx2 : '' ?></div>
										</td>
										<tr height="60px">
											<td align="right">
										...
										<tr height="60px">
											<td>&nbsp;</td>
											<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="padding: 10px 10px;" type="submit" value="Đổi mật khẩu" id="submit" name="submit"></td>
										</tr>
									</span>
									</table>
