	...
	if(isset($_POST['Password'])){
		...
		if($validated_data === false) {
			...
			if(preg_match($partten ,$pass, $matchs) && preg_match($partten ,$pass2, $matchs))
			{
				...
				$error1 = "Mật khẩu 1 chưa đúng định dạng.<br>Mật khẩu đúng địng dạng có mẫu: Hkdevuong2016<br>Vừa có kí tự chữ hoa nằm đầu tiên, vừa có kí tự chữ thường và vừa có chữ số";
			}
			else{
...
<div style="width:100%; height:100%; padding-top:0%;" align="center">
	<hr style="margin: 15px 0;">		
		<span align="center"><h1><font color="blue">Đổi mật khẩu</font></h1></span>
	<hr style="margin: 15px 0;">
...
<tr>
    <td class="span"  align="right">
        Mật khẩu mới:     </td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input class="srk" type="password" value="" id="password" name="Password" size="36" maxlength="16"  placeholder="Mật khẩu mới | A-Za-z0-9 | ******" pattern="[A-Za-z0-9]+">
...
<tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input class="srk" type="password" value="" id="verifyPassword" name="verifyPassword" size="36" maxlength="16" placeholder="Nhập lại mật khẩu mới | A-Za-z0-9 | ******" pattern="[A-Za-z0-9]+">
