...
<a href="./?a=ranking" class="style1 style2">Xếp hạng cấp độ</a> | <a href="./?a=tlc" class="style2">Xếp hạng thế lực chiến</a> | <a href="./?a=taiphu" class="style2">Xếp hạng tài phú</a>
...
<hr style="margin: 5px 0;"></font></b>
	<table align='center' width='95%' border='0' cellspacing='0' cellpadding='0'>
		<tr style="color:#CCCCFF;background-color:#000000;font-weight:bold;" height="30px">
			...
			<td width="5%"><FONT COLOR="White"><center><b>T.chức</td>
			<td width="10%"><FONT COLOR="White"><center><b>Võ huân</td>
			<td width="5%"><FONT COLOR="White"><center><b>T.sinh</td>
		</tr>
<?php
	...
	for ( $i = $page-2; $i <= $page+2; $i++ )
	{
		if($i>=0 && $i<=$sotrang)
		{
			if($i==$page)
				...
				echo "<a href='?a=ranking&page=".$i."&char=".$char."'><font color='black'>".$i."</font></a> ";
		}
	}
	 ?>
	  | 
