...
<div align="center">
	<table width="83%" border="0">
		<tr  align="center">
			<td width="16%">
				<a href="?a=webshop&page=0&type=0">
			  <h2><font color="blue">Tất cả</font></h2></a>
		  </td>
			<td width="18%">
				<a href="?a=webshop&page=0&type=1">
			  <h2><font color="blue">Kỳ phẩm</font></h2></a>
		  </td>
			<td width="20%">
				<a href="?a=webshop&page=0&type=2">
			  <h2><font color="blue">Áo choàng nữ</font></h2></a>
		  </td>
			<td width="22%">
				<a href="?a=webshop&page=0&type=3">
			  <h2><font color="blue">Áo choàng nam</font></h2></a>
		  </td>
			<td width="24%">
				<a href="?a=webshop&page=0&type=7">
			  <h2><font color="blue">Pill Train</font></h2></a>
		  </td>
			<!--
			<td width="25%">
				<a href="?a=webshop&page=0&type=4"><h2><font color="blue">TEST</font></h2></a>
			</td>
			-->
		</tr>
  </table>
...
while(odbc_fetch_row($item))
{
	...
	if($i>=$line*$page && $i<$line*($page+1))
	{
		...
		<td><center><FONT COLOR='Black'>&nbsp;".$tenitem."&nbsp;</td>
		...
		<td><center><FONT COLOR='Black'>&nbsp;".$desitem."&nbsp;</td>
		<td><center><FONT COLOR='Red'>&nbsp;".(odbc_result($item, 6)==0?"V.viễn":odbc_result($item, 6)." ngày")."&nbsp;</td>
		</tr>";
	}
}
